...
def linear_inserstion_sorted(array, target): 
    sorted_array = insertion_sort(array) 
    result = linear_search(sorted_array, target) 
    return result  

def linear_bubble_sorted(array, target): 
    sorted_array = bubble_sort(array)  
    result = linear_search(sorted_array, target) 
    return result  

def binary_bubble_sorted(array, target): 
    sorted_array = bubble_sort(array) 
    result = binary_search(sorted_array, target)
    return result

unsorted_list = [random.randint(1, 5000) for n in range(5000)]
target = random.randint(1, 1000) 

def make_List(): 
     return [random.randint(1, 500) for n in range(5000)] 
...
linear_inserstion_sorted_time = timeit.timeit(lambda: linear_inserstion_sorted(make_List(), target), number =1) 
binary_inserstion_sorted_time = timeit.timeit(lambda: binary_search_sorted(make_List(), target), number =1) 
linear_bubble_sorted_time = timeit.timeit(lambda: linear_bubble_sorted(make_List(), target), number =1) 
binary_bubble_sorted_time = timeit.timeit(lambda: binary_bubble_sorted(make_List(), target), number =1)

print(f"Binary Search (With Sorting) Execution Time: {binary_time:.6f} seconds")
print(f"Linear Search Execution Time: {linear_time:.6f} seconds") 
print(f"linear insertion time {linear_inserstion_sorted_time:.6f} seconds") 
print(f"Binary insertion time {binary_inserstion_sorted_time:.6f} seconds")
print(f"linear bubble time {linear_bubble_sorted_time:.6f} seconds")
print(f"Binary bubble time {binary_bubble_sorted_time:.6f} seconds")
