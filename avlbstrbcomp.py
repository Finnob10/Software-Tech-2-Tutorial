...
class RedBlackNode:
    def __init__(self, name, phone, colour="red"):
        self.name = name 
        self.phone = phone
        self.colour = colour
        self.parent = None
...
class RedBlackTree:
    ...
    def insert_node(self, name, phone):
...
def benchmark(n=1000, search_fraction=0.5, delete_count=100, verbose=True):
    ...
    start = time.time()
    for i in range(n):
        rb.insert_node(names[i], phones[i])
    ...
    if verbose:
        ...
        print("---------------------------------------------")
        print(f"Insertions:      {bst_insert_time:.6f}        {avl_insert_time:.6f}        {rb_insert_time:.6f}")
        print(f"Searches:        {bst_search_time:.6f}        {avl_search_time:.6f}        {rb_search_time:.6f}")
        print(f"Deletions:       {bst_delete_time:.6f}        {avl_delete_time:.6f}        {rb_delete_time:.6f}")
        print("---------------------------------------------")
...
class BenchmarkApp:
    def __init__(self, master):
        self.master = master
        master.title("BST vs AVL Benchmark vs Red Black")
        ...
        self.tree = ttk.Treeview(master, columns=("BST", "AVL", "RB"), show='headings')
    ...
    def run_benchmark(self):
        ...
        summary = (
            ...
            f"Found in Search: BST: {results['Found In Search'][0]}, AVL: {results['Found In Search'][1]}, RB: {results['Found In Search'][2]:.6f}s out of 1000\n"
        )
        ...
        for op in ['Insertions', 'Searches', 'Deletions']:
            ...
            self.tree.insert('', tk.END, values=(f"{bst_time:.6f}", f"{avl_time:.6f}",  f"{rb_time:.6f}"), text=op)
